...
[btrfs 스냅샷 설정](2018-12-26-install_ubuntu1804-02-btrfs.md#Automatically-Snapshot-Creation) 에서 주기적으로 스냅샷이 적용되고 있기 때문에 파일의 `속성 - 이전 버전` 을 누르면 아래 그림과 같이 스냆샷 목록이 나온다.
